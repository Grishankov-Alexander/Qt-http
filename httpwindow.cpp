      ...
      httpRequestAborted(false)
{
    ...
    connect(downloadButton, &QPushButton::clicked, this, &HttpWindow::downloadFile);
...
void HttpWindow::downloadFile()
{
    ...
    if (!newUrl.isValid()) {
        QMessageBox::information(
                    this, tr("Error"), tr("Invalid URL: %1: %2")
    ...
    if (QFile::exists(fileName)) {
        if (QMessageBox::question(this, tr("OverwriteExisting File"),
            tr("There already exists a file called %1%2. Overwrite?")
            .arg(fileName, useDirectory ? QString()
...
QFile *HttpWindow::openFileForWrite(const QString &fileName)
{
    ...
    if (!file->open(QIODevice::WriteOnly)) {
        QMessageBox::information(
                    this, tr("Error"), tr("Unable to save the file %1: %2.")
...
void HttpWindow::httpFinished()
{
    ...
    const QVariant redirectionTarget = reply->attribute(
    ...
    statusLabel->setText(tr("Download %1 bytes to %2\nin\n%3")
                         .arg(fi.size()).arg(fi.fileName(),
...
void HttpWindow::sslErrors(QNetworkReply *, const QList<QSslError> &errors)
{
    ...
    if (QMessageBox::warning(this, tr("SSL Errors"),
            ...
            .arg(errorString), QMessageBox::Ignore | QMessageBox::Abort)
         == QMessageBox::Ignore)
